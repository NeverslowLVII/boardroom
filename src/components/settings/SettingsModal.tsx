            ...
            <div className="space-y-4">
                ...
                <div key={conn.id} className="rounded-xl border border-zinc-800 bg-zinc-800/30 p-4">
                  <div className="mb-3 flex items-center justify-between">
                    <input
                      ...
                      className="border-none bg-transparent text-[13px] font-medium text-zinc-100 outline-none placeholder:text-zinc-600"
              ...
              <button
                ...
                className="flex w-full items-center justify-center gap-2 rounded-xl border border-dashed border-zinc-700 py-4 text-[13px]
                  text-zinc-500 transition-colors hover:border-zinc-600 hover:text-zinc-300"
              >
  ...
  return (
    <div>
      ...
      <input
        ...
        className="w-full rounded-lg border border-zinc-800 bg-zinc-950 px-3 py-2 text-[13px] text-zinc-300
          outline-none placeholder:text-zinc-600 focus:border-zinc-700 focus:ring-1 focus:ring-zinc-700"
      />
    </div>
  );
}
